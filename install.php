...
$result = CRest::call(
	...
	[
		...
		'TYPE' => 'B',// Bot type
		'EVENT_MESSAGE_ADD' => "https://team.promo-bot.ru/app/chat/handler.php", //$handlerBackUrl,// Bot handler for new messages from user (req.)
		'EVENT_WELCOME_MESSAGE' => "https://team.promo-bot.ru/app/chat/handler.php", //$handlerBackUrl,// Bot handler for joining to a chat (req.)
		'EVENT_BOT_DELETE' => "https://team.promo-bot.ru/app/chat/handler.php", //$handlerBackUrl,// Bot handler for deleting bot (req.)
		'PROPERTIES' => [ // Bot personality (req.)
			'NAME' => 'Федя',// Bot name (NAME or LAST_NAME is required)
			'LAST_NAME' => '',// Bot last name
			...
			'EMAIL' => 'webmaster@promo-bot.ru',
			'PERSONAL_BIRTHDAY' => '2021-09-01',// format YYYY-mm-dd
			'WORK_POSITION' => 'Помогу чем смогу',// Bot 'job-title' as a bot description
			'PERSONAL_WWW' => '',
